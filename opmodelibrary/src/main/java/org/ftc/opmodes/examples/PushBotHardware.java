...
//
//--------
// Extends the OpMode class to provide stopMode single hardware access point for the
// Push Bot.
//--------
@Disabled
...
public class PushBotHardware extends OpMode {
    ...
    //
    //--------
    // Scale the joystick input using stopMode nonlinear algorithm.
    //--------
    ...
    (double p_left_count
        ...
        if ((Math.abs(v_motor_left_drive.getCurrentPosition()) > p_left_count) &&
            ...
            //
            // Set the status to stopMode positive indication.
            //
            l_status = true;
        }
